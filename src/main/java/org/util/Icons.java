...
public class Icons {
    ...
    public static Icon feederDark = getIcon("/icons/feeder_dark.svg");

    // 支持设置宽高
    public static Icon wenjianjia = getIcon("/icons/wenjianjia.svg");
//    public static Icon wenjianjia = getIcon("/icons/wenjianjia.svg",96, 96);
